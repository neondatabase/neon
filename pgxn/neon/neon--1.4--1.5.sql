...
-- left. If you are only interested in the changes from your own session,
-- store the values at the beginninng of the session somewhere, and subtract
-- them on subsequent calls.
CREATE VIEW neon_backend_perf_counters AS
  SELECT P.procno, P.pid, P.metric, P.value
