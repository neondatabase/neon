...
XLogRecPtr neon_set_lwlsn_block_v_hook set_lwlsn_block_v_hook(const XLogRecPtr *lsns, RelFileLocator relfilenode, ForkNumber forknum, BlockNumber blockno, int nblocks);
