...
impl ComputeControlPlane {
    ...
    fn create_jwks_from_pem(pem: Pem) -> Result<JwkSet> {
        let der_data = pem.into_contents();
        // The length of an Ed25519 public key is 32 and it is located in the
        // last 32 bytes.
        let key = &der_data[der_data.len() - 32..];
        ...
        Ok(JwkSet {
            keys: vec![Jwk {
                ...
                algorithm: AlgorithmParameters::OctetKeyPair(OctetKeyPairParameters {
                    ...
                    x: base64::encode_config(key, base64::URL_SAFE_NO_PAD),
                }),
            }],
        })
    }
    ...
    pub fn new_endpoint(
        ...
        let compute_ctl_config = ComputeCtlConfig {
            jwks: Self::create_jwks_from_pem(pem::parse(self.env.read_public_key()?)?)?,
            tls: None::<TlsConfig>,
        };
