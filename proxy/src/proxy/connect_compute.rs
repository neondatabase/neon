...
pub(crate) fn invalidate_cache(node_info: control_plane::CachedNodeInfo) {
    ...
    M::Error: From<WakeComputeError>,
{
    ...
    let node_info = wake_compute(&mut num_retries, ctx, backend, wake_compute_retry_config).await?;
