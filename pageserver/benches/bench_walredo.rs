...
//!
//! ```text
//! async-short/1           time:   [24.234 µs 24.377 µs 24.548 µs]
//! async-short/2           time:   [32.901 µs 33.069 µs 33.256 µs]
//! async-short/4           time:   [41.939 µs 42.261 µs 42.622 µs]
//! async-short/8           time:   [70.791 µs 71.354 µs 71.996 µs]
//! async-short/16          time:   [126.12 µs 128.03 µs 130.10 µs]
//! async-short/32          time:   [253.94 µs 257.13 µs 260.26 µs]
//! async-short/64          time:   [508.06 µs 510.84 µs 513.93 µs]
//! async-short/128         time:   [989.23 µs 994.79 µs 1.0009 ms]
//! async-medium/1          time:   [108.49 µs 108.85 µs 109.29 µs]
//! async-medium/2          time:   [152.22 µs 152.67 µs 153.21 µs]
//! async-medium/4          time:   [315.57 µs 317.53 µs 320.00 µs]
//! async-medium/8          time:   [637.53 µs 644.68 µs 652.68 µs]
//! async-medium/16         time:   [1.2644 ms 1.2785 ms 1.2941 ms]
//! async-medium/32         time:   [2.4983 ms 2.5287 ms 2.5620 ms]
//! async-medium/64         time:   [4.8005 ms 4.8612 ms 4.9247 ms]
//! async-medium/128        time:   [8.8422 ms 8.9796 ms 9.1173 ms]
//! sync-short/1            time:   [25.394 µs 25.495 µs 25.616 µs]
//! sync-short/2            time:   [30.656 µs 30.807 µs 30.996 µs]
//! sync-short/4            time:   [44.302 µs 44.662 µs 45.050 µs]
//! sync-short/8            time:   [83.849 µs 84.529 µs 85.202 µs]
//! sync-short/16           time:   [182.13 µs 183.88 µs 185.55 µs]
//! sync-short/32           time:   [377.13 µs 378.88 µs 380.67 µs]
//! sync-short/64           time:   [753.36 µs 755.84 µs 758.42 µs]
//! sync-short/128          time:   [1.4788 ms 1.4834 ms 1.4883 ms]
//! sync-medium/1           time:   [105.01 µs 105.52 µs 106.15 µs]
//! sync-medium/2           time:   [152.05 µs 152.56 µs 153.21 µs]
//! sync-medium/4           time:   [324.07 µs 325.59 µs 327.52 µs]
//! sync-medium/8           time:   [646.98 µs 651.50 µs 656.33 µs]
//! sync-medium/16          time:   [1.2567 ms 1.2637 ms 1.2712 ms]
//! sync-medium/32          time:   [2.4260 ms 2.4435 ms 2.4615 ms]
//! sync-medium/64          time:   [4.6333 ms 4.6639 ms 4.6927 ms]
//! sync-medium/128         time:   [8.7162 ms 8.8256 ms 8.9271 ms]
//! ```
