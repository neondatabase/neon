...
//!
//! ```text
//! async-short/1           time:   [24.169 µs 24.287 µs 24.429 µs]
//! async-short/2           time:   [32.819 µs 32.992 µs 33.189 µs]
//! async-short/4           time:   [42.271 µs 42.594 µs 42.961 µs]
//! async-short/8           time:   [71.411 µs 72.073 µs 72.850 µs]
//! async-short/16          time:   [128.73 µs 130.50 µs 132.51 µs]
//! async-short/32          time:   [253.79 µs 256.85 µs 259.88 µs]
//! async-short/64          time:   [506.64 µs 509.39 µs 512.30 µs]
//! async-short/128         time:   [991.36 µs 996.22 µs 1.0017 ms]
//! async-medium/1          time:   [108.97 µs 109.49 µs 110.24 µs]
//! async-medium/2          time:   [152.74 µs 153.37 µs 154.18 µs]
//! async-medium/4          time:   [315.38 µs 317.43 µs 320.04 µs]
//! async-medium/8          time:   [630.32 µs 634.28 µs 639.21 µs]
//! async-medium/16         time:   [1.2583 ms 1.2714 ms 1.2864 ms]
//! async-medium/32         time:   [2.5164 ms 2.5514 ms 2.5886 ms]
//! async-medium/64         time:   [4.7624 ms 4.8041 ms 4.8477 ms]
//! async-medium/128        time:   [8.9154 ms 9.0808 ms 9.2274 ms]
//! sync-short/1            time:   [25.433 µs 25.530 µs 25.645 µs]
//! sync-short/2            time:   [31.152 µs 31.413 µs 31.705 µs]
//! sync-short/4            time:   [44.834 µs 45.162 µs 45.509 µs]
//! sync-short/8            time:   [83.792 µs 84.307 µs 84.848 µs]
//! sync-short/16           time:   [183.73 µs 184.54 µs 185.34 µs]
//! sync-short/32           time:   [376.51 µs 377.88 µs 379.21 µs]
//! sync-short/64           time:   [752.72 µs 755.09 µs 757.52 µs]
//! sync-short/128          time:   [1.4804 ms 1.4853 ms 1.4901 ms]
//! sync-medium/1           time:   [105.11 µs 105.53 µs 106.05 µs]
//! sync-medium/2           time:   [152.35 µs 153.23 µs 154.36 µs]
//! sync-medium/4           time:   [324.62 µs 326.29 µs 328.37 µs]
//! sync-medium/8           time:   [641.42 µs 645.50 µs 650.22 µs]
//! sync-medium/16          time:   [1.2526 ms 1.2577 ms 1.2629 ms]
//! sync-medium/32          time:   [2.4014 ms 2.4140 ms 2.4268 ms]
//! sync-medium/64          time:   [4.6458 ms 4.6778 ms 4.7085 ms]
//! sync-medium/128         time:   [8.6543 ms 8.7735 ms 8.8870 ms]
//! ```
