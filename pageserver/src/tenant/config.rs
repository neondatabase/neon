...
use pageserver_api::models::{
    project_fields, TenantConfigProjection, TenantConfigRequest, TenantCreateRequest,
};
...
impl TryFrom<&'_ TenantConfigProjection> for TenantConfOpt {
    type Error = anyhow::Error;

    fn try_from(request_data: &TenantConfigProjection) -> Result<Self, Self::Error> {
...
impl TryFrom<&'_ TenantCreateRequest> for TenantConfOpt {
    ...
    fn try_from(request_data: &TenantCreateRequest) -> Result<Self, Self::Error> {
        let tenant_config_projection = project_fields(request_data);
        TenantConfOpt::try_from(&tenant_config_projection)
    }
}
