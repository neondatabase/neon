...
def test_ancestor_branch(neon_env_builder: NeonEnvBuilder):
    ...
    env.pageserver.safe_psql(
        "failpoints flush-frozen-before-sync=sleep(10000)")
    ...
    branch0_lsn = query_scalar(branch0_cur,
    ...
    # Create branch1.
    env.neon_cli.create_branch("branch1",
                               "main",
                               tenant_id=tenant,
    ...
    branch1_lsn = query_scalar(branch1_cur,
                               "SELECT pg_current_wal_insert_lsn()")
    ...
    # Create branch2.
    env.neon_cli.create_branch("branch2",
                               "branch1",
                               tenant_id=tenant,
    ...
    branch2_lsn = query_scalar(branch2_cur,
                               "SELECT pg_current_wal_insert_lsn()")
