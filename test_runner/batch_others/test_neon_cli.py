...
def helper_compare_timeline_list(
        pageserver_http_client: NeonPageserverHttpClient, env: NeonEnv,
    ...
    cli_timeline_ids = sorted(
        [timeline_id for (_, timeline_id) in timelines_cli])
...
def test_cli_timeline_list(neon_simple_env: NeonEnv):
    ...
    helper_compare_timeline_list(pageserver_http_client, env,
                                 env.initial_tenant)
...
def helper_compare_tenant_list(
        pageserver_http_client: NeonPageserverHttpClient, env: NeonEnv):
