...
def test_create_snapshot(
    ...
    compatibility_snapshot_dir = top_output_dir / f"compatibility_snapshot_pgv{pg_version}"
...
def test_backward_compatibility(
    ...
    ), f"COMPATIBILITY_SNAPSHOT_DIR is not set. It should be set to `compatibility_snapshot_pgv{pg_version}` path generateted by test_create_snapshot (ideally generated by the previous version of Neon)"
