...
class RemoteExtension(StrEnum):
    ...
    def archive_route(self, build_tag: str, pg_version: PgVersion) -> str:
        return f"{build_tag}/v{pg_version}/extensions/{self.compressed_tarball_name}"
...
def test_remote_extensions(
    ...
    httpserver.expect_request(
        f"/pg-ext-s3-gateway/{extension.archive_route(build_tag=os.environ.get('BUILD_TAG', 'latest'), pg_version=pg_version)}",
        method="GET",
