...
RUN case "${PG_VERSION}" in "v17") \
    ...
    wget https://github.com/neondatabase/pg_session_jwt/archive/a275360b9b7a89394b6768b2ca91976da78aa37a.tar.gz -O pg_session_jwt.tar.gz && \
    echo "cd856c5d60547f6ceb8d30753b5df39a70dca4d2167a90dcd2b2254e7418694b pg_session_jwt.tar.gz" | sha256sum --check && \
