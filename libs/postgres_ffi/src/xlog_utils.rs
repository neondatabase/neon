...
use crate::pg_constants::{
    self, RM_LOGICALMSG_ID, XLOG_LOGICAL_MESSAGE, XLP_LONG_HEADER, XLR_BLOCK_ID_DATA_LONG,
...
impl WalGenerator {
    ...
    fn encode_logical_message(prefix: &CStr, message: &[u8]) -> Bytes {
    ...
    fn encode_record(data: Bytes, rmid: u8, info: u8, prev_lsn: Lsn) -> Bytes {
